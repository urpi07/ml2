<html>
	<head>
		...
		<script src="<?php echo base_url(); ?>assets/fontawesome-free-5.0.8/svg-with-js/js/fontawesome-all.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/js/weblib.js"></script>
	</head>
	<body>		